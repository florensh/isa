...
/**
 * Performance test for the StoreMap entity.
 */
class StoreMapGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StoreMap entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created storeMap")
                .get("${new_storeMap_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created storeMap")
            .delete("${new_storeMap_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
