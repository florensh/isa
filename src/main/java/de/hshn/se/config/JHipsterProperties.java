...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "isa@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "isa API";

        private String description = "isa API documentation";
